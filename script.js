...
function ensureContribApi() {
  ...
  if (!contribApiPromise) {
    contribApiPromise = import("./contributions.js")
      .then((mod) => {
        contribApi = mod;
        return mod;
      })
    ...
    el.innerHTML = `
      <div class="carousel__area">
        <div class="shadow" aria-hidden="true">
          <img class="shadow__layer shadow__layer--sharp" src="./images/shadow.svg" alt="" />
          <img class="shadow__layer shadow__layer--soft" src="./images/shadow.svg" alt="" />
          <img class="shadow__layer shadow__layer--softer" src="./images/shadow.svg" alt="" />
          <img class="shadow__layer shadow__layer--softest" src="./images/shadow.svg" alt="" />
        </div>
